...
gmx grompp -f $MDP/min_$LAMBDA.mdp -c $FREE_ENERGY/centered.gro -r $FREE_ENERGY/centered.gro -p $FREE_ENERGY/topol.top -n $FREE_ENERGY/index.ndx -o min_$LAMBDA.tpr
